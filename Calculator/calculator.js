...
window.onload = function() {
    ...
    add an event listener so that the anonymous function provided is executed when the element is clicked */
    document.getElementById("calculate").addEventListener("click", function() {
        //retrieve value from user input on the form
        ...
        //call calculate function with those values and display results
